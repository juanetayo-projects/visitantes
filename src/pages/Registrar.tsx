...
import { PageHeader, Card, Btn, selectCls, inputCls, Badge } from '../components/ui'
        ...
        <div className="grid gap-5 lg:grid-cols-5">
          ...
          {tipo === 'familiar' && (
            <Card className="p-5 lg:col-span-3">
              ...
              {pisoId && <MapaHabitaciones pisoId={pisoId} refreshKey={refreshMapa} onSelect={(o) => { if (o.num_ingreso) setSel(o) }} />}
            </Card>
          )}
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-3 gap-2">
                <div className="col-span-2">
                  ...
                  <input className={inputCls} value={cedula} onChange={(e) => setCedula(e.target.value)} onBlur={lookupCedula} placeholder="N° documento" />
                </div>
